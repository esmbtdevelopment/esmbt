...
export default function EDeliveryNotePage() {
    ...
    const featureIcons = [
        <FaFileInvoiceDollar key="icon-1" />,
        <FaChartLine key="icon-2" />,
        <FaCheck key="icon-3" />,
        <FaShieldAlt key="icon-4" />
    ];
                ...
                <div className="container mx-auto px-4 sm:px-6 md:px-12">
                    <div className="max-w-6xl mx-auto relative z-10">
                        ...
                        >
                            ...
                            <span className="text-sm sm:text-base">{tNav('backToProducts')}</span>
                        </Link>
