        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="lg:col-span-2 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-8 font-sora leading-tight">
              ...
              <div className="flex items-center space-x-6 mb-12">
                <button
                  ...
                  className="w-10 h-10 bg-white border border-sky-200 shadow-sm flex items-center justify-center hover:shadow-md hover:bg-sky-50 hover:border-sky-300 transition-all duration-200"
                >
            ...
            <div className="relative">
              <div className="relative">
                ...
                <div className="relative bg-white shadow-xl p-10 md:p-12 border border-sky-100">
                  ...
                  <blockquote className="text-gray-800 text-sm md:text-base leading-relaxed mb-10 font-montserrat italic border-l-4 border-sky-200 pl-6">
                  ...
                  <div className="border-t border-sky-100 pt-8">
                    <div className="flex items-start justify-between">
                      <div className="flex items-start space-x-4">
                        <div className="relative w-10 h-10 bg-sky-50 border border-sky-100 flex items-center justify-center rounded-lg overflow-hidden">
                          <Image
