  ...
  return (
    <div className="relative py-24 bg-gradient-to-br from-gray-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-20 right-20 w-40 h-1 bg-gradient-to-r from-transparent via-gray-300 to-transparent"></div>
        <div className="absolute bottom-20 left-20 w-1 h-40 bg-gradient-to-b from-transparent via-gray-300 to-transparent"></div>
      </div>

      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-start">

        <div className="lg:col-span-2 grid lg:grid-cols-2 gap-12 items-center">
          {/* Left Column - Header and Controls */}
          <div className="relative">
            {/* Professional badge */}
            <div className="inline-flex items-center space-x-3 bg-gradient-to-r from-sky-100 to-blue-100 border border-sky-200 shadow-sm rounded-lg px-6 py-3 mb-8">
              <div className="w-2 h-2 bg-sky-600 rounded-full"></div>
              <span className="text-sky-700 font-semibold font-montserrat text-sm tracking-wide uppercase">Client Testimonials</span>
            </div>

            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-8 font-sora leading-tight">
              Enterprise Leaders <br />
            ...
            <div className="flex items-center space-x-6 mb-12">
              <button
                ...
                className="w-14 h-14 bg-white border border-sky-200 shadow-sm flex items-center justify-center hover:shadow-md hover:bg-sky-50 hover:border-sky-300 transition-all duration-200"
              >
                  ...
                  <button
                    ...
                    className={`h-1 rounded-full transition-all duration-300 ${
                      index === activeTestimonial 
                        ? 'bg-sky-600 w-8' 
                        : 'bg-gray-300 w-4 hover:bg-sky-400'
                    }`}
                  />
                ))}
              </div>
            ...
            <button className="group inline-flex items-center space-x-3 bg-gradient-to-r from-sky-600 to-blue-600 text-white px-8 py-4 font-semibold hover:from-sky-700 hover:to-blue-700 transition-all duration-200 font-montserrat shadow-md hover:shadow-lg">
              <span>View All Case Studies</span>
              <RiArrowRightLine className="text-lg group-hover:translate-x-1 transition-transform duration-200" />
            </button>

            {/* Professional Stats Display - moved below for better positioning */}
            <div className="mt-12 grid grid-cols-3 gap-6 lg:hidden">
              <div className="text-center p-4 bg-gradient-to-r from-sky-50 to-blue-50 rounded-lg border border-sky-100">
                <div className="text-2xl font-bold text-sky-700 font-sora">200+</div>
                <div className="text-xs text-sky-600 font-montserrat">Enterprise Clients</div>
              </div>
              <div className="text-center p-4 bg-gradient-to-r from-sky-50 to-blue-50 rounded-lg border border-sky-100">
                <div className="text-2xl font-bold text-sky-700 font-sora">500+</div>
                <div className="text-xs text-sky-600 font-montserrat">SAP Implementations</div>
              </div>
              <div className="text-center p-4 bg-gradient-to-r from-sky-50 to-blue-50 rounded-lg border border-sky-100">
                <div className="text-2xl font-bold text-sky-700 font-sora">15+</div>
                <div className="text-xs text-sky-600 font-montserrat">Years Experience</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="relative">
              ...
              <div className="relative bg-white shadow-xl p-10 md:p-12 border border-sky-100">
                {/* Professional corner accent */}
                <div className="absolute top-0 left-0 w-20 h-1 bg-gradient-to-r from-sky-600 to-blue-600"></div>
                
                {/* Company verification badge */}
                <div className="absolute top-6 right-6 flex items-center space-x-2 text-xs text-sky-600">
                ...
                <div className="flex items-center space-x-2 mb-6">
                  ...
                  <span className="ml-3 text-sm text-sky-600 font-montserrat font-semibold">Excellent</span>
                </div>
                ...
                <div className="border-t border-sky-100 pt-8">
                  <div className="flex items-start justify-between">
                    <div className="flex items-start space-x-4">
                      <div className="relative w-16 h-16 bg-sky-50 border border-sky-100 flex items-center justify-center rounded-lg overflow-hidden">
                        <Image
                      ...
                      <div>
                        <div className="font-bold text-gray-900 font-sora text-lg mb-1">
                          {currentTestimonial.author}
                        </div>
                        <div className="text-sky-600 font-montserrat font-semibold mb-1">
                    ...
                    <div className="text-right flex flex-col items-end">
                      ...
                      <div className="text-xs text-sky-600 font-montserrat font-semibold">
